...
<p align="center"><img alt="unsolicited opinion from a valued user of apache-works" height="300" src="https://cataas.com/cat/says/I%20love%20apache-works!"></p>
...
| bash/php | ```php -m``` | list modules |
| bash/laravel | <code>docker exec -it laravel-app bash -c "sudo -u devuser /bin/bash"</code> | proper way to ssh into laravel container |
